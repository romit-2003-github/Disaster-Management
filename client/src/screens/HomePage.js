          ...
          <div className='md:max-w-[1480px] m-auto max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='flex justify-center py-8 md:gap-8 '>
              <div className='grid md:grid-cols-4 grid-cols-2 gap-2'>
                ...
                <img src={companyLogo2} style={{width:'10rem'}} alt='Loading' className='w-20 h-20 mx-8' />
                <img src={companyLogo3} style={{width:'10rem'}} alt='Loading' className='w-20 h-20 mx-8' />
                <img src={companyLogo4} style={{width:'15rem'}} alt='Loading' className='w-20 h-20 mx-8' />
              </div>
            </div>
          </div>
          <Campains />
